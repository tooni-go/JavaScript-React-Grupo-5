  ...
  return (
    <AuthGuard requireAdmin>
      <div className="flex min-h-[calc(100vh-4rem)] bg-slate-50 dark:bg-slate-900">
        <aside className="sticky top-0 h-[calc(100vh-4rem)] flex w-64 flex-col border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
          ...
          <nav className="flex-1 overflow-y-auto py-4 flex flex-col">
            ...
            <div className="mt-auto px-3 pt-4 border-t border-slate-200 dark:border-slate-800">
              <Link
                ...
                className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white"
              >
                <ArrowLeft className="h-5 w-5 opacity-75" />
                Volver al Mapa
              </Link>
            </div>
          </nav>
